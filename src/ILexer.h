// Scintilla ILexer5 interface
// Based on Scintilla's ILexer interface
...
public:
    ...
    virtual void SCI_METHOD Lex(Sci_Position startPos, Sci_Position lengthDoc, int initStyle, IDocument *pAccess) = 0;
    virtual void SCI_METHOD Fold(Sci_Position startPos, Sci_Position lengthDoc, int initStyle, IDocument *pAccess) = 0;
